...
run-virtual: build-virtual
	VENV_DIR=.venv $(CCF_PREFIX_VIRTUAL)/bin/sandbox.sh -p $(BUILD)/liblskv.virtual.so -e virtual -t virtual  --initial-member-count 3 --initial-user-count 10   --max-http-body-size 104857600 
