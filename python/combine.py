...
def run_fl_simulation(malicious=False):
    ...
    return user_losses_training, user_accuracies_training, user_losses_testing, user_accuracies_testing, time_records
...
def main():
    ...
    normal_results = run_fl_simulation(malicious=False)

    # Run the FL simulation with model poisoning
    print("Running FL simulation with model poisoning attack")
    poisoned_results = run_fl_simulation(malicious=True)

    # Plot and compare the results
    plot_training_testing_results(*normal_results, os.path.join(results_dir, "normal"))
    plot_training_testing_results(*poisoned_results, os.path.join(results_dir, "poisoned"))
